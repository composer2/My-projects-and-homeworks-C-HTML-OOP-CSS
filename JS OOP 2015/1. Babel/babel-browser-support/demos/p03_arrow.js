...
(function () {
	...
	var squares1 = numbers.map(function (n) {
		return n * n;
	});
	var squares2 = numbers.map(function (n) {
		return n * n;
	});
	...
	var div = {
		color: "red",
		children: [{ id: "e1", color: "blue" }, { id: "e2", color: "blue" }],
		setChildrenColor1: function setChildrenColor1() {
			this.children.forEach(function (child) {
				//child.color = this.color; //error b/c this not captured
			});
		},
		setChildrenColor2: function setChildrenColor2() {
			var that = this;
			this.children.forEach(function (child) {
				child.color = that.color;
			});
		},
		setChildrenColor3: function setChildrenColor3() {
			var _this = this;
