namespace Dealership.Common
{
    public class Constants
    {
        ...
        public const string InvalidPassword = "Password must containt only letters and  digits";
        public const string InvalidUserName = "Username contains invalid symbols!";
