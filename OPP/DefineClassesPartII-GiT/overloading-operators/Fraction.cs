...
namespace overloading_operators
{
    class Fraction
    {
        ...
        private static long GreatestCommonDevisor(long firstNumber, long secondNumber)
        {
        ...
        //operator ++(same for prefix and postfix form)
        ...
        //explicit conversation to double operator
